...
if __name__ == "__main__":
    # 여기다가 실제 뉴스 기사 넣고, 일부러 길게 만들고 싶으면 * 3, * 5 이런 식으로 반복
    long_text = """
...
전균 삼성증권 파생상품 연구원은 블룸버그통신을 통해 “코스피가 사상 최고치를 기록한 데 따른 투자자들의 불안 심리가 VKOSPI에 반영됐다”면서도 시장 조정이 임박했다는 의미는 아니라고 주장했다. 그러면서 “랠리에 대한 기대가 과도하게 커졌고 콜옵션(매수할 권리)이 과대평가된 것으로 보인다”고 진단했다.

블룸버그통신에 따르면 외국인투자가들은 인공지능(AI) 관련주 ‘거품론’으로 코스피가 단기 침체를 겪자 한국 보유 자산을 조정하기 시작했다. 지난주 코스피가 3.7% 하락하며 4월 이후 가장 큰 하락폭을 기록한 데 따라 1조 6500억 원(약 11억 달러) 상당의 선물을 매도했다. 블룸버그는 자체 자료를 인용해 콜옵션과 풋옵션의 가격이 모두 상승했다면서도 이 가운데 코스피200의 10% 이상 상승에 베팅하는 1개월 만기 콜옵션의 내재 변동성이 최근 1년 평균치를 웃돌고 있다고 보도했다.
